...
var theseDamnCats = [], kittyCage = {
    _requestTime: 0,
    _lastUpdate: 0,
    _crayCounter: 0,
    phaseTwo: false,
    crayCount: function(action) {
        //action can be a timestamp of "reset"...confusing, but ok...i guess
        if (action === "reset") {
            this._crayCounter = 0;
...
Cat.prototype.randoCatMotion = function(num) {
    var followOrIgnore = Math.random() >= .3 ? true : false;
    if (followOrIgnore) {
        return num;
    } else {
...
function addCats(cats, direction) {
    ...
    window.document.addEventListener("mousemove", function(e) {
        if (window.document.querySelector(".crazy-bar").classList.contains("catInvasionPhaseTwo")) {
                        ...
                        switch (true) {
                          case kittyCage.crayCount() >= 250:
                            ...
                            if (cat.aboutToDisappear !== true) {
                                ...
                                window.document.querySelector(".crazy-bar").classList.add("catInvasionPhaseTwo");
                            }
                            ;
                            break;
                          ...
                          case kittyCage.crayCount() >= 40:
                            cat.style.webkitAnimation = "shake .25s " + Math.random() * .75 + "s linear infinite";
                            break;
                        }
